    ...
    <div className="space-y-6 p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-4">
        {students.map((student: Student) => (
          <Card key={student.id} className="flex flex-col items-center p-4 shadow-lg hover:shadow-xl transition-shadow duration-200">
            ...
            <CardContent className="flex flex-col items-center mt-4">
              ...
              <p className="mt-2 text-gray-600 text-sm text-center">Scan to mark attendance</p>
            </CardContent>
          </Card>
        ))}
      </div>
